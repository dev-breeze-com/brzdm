...
#define APPNAME	"brzdm"
#define DISPLAY	":0.0"
#define BINPATH "/bin:/usr/bin:/sbin:/usr/sbin:/usr/local/bin"

#define CONSOLE_STR		"console"
#define SHUTDOWN_STR	"halt"
#define REBOOT_STR		"reboot"
#define EXIT_STR		"exit"
#define KIOSK_STR		"kiosk"
...
/* syslog flags */
#define LOGFLAGS (LOG_ALERT|LOG_USER)

#define INPUT_MAXLENGTH_USERNAME  64
#define INPUT_MAXLENGTH_PASSWORD  128
